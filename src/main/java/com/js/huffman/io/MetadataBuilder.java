...
public class MetadataBuilder {
    ...
    /**
     * This method packs all the metadata that we will need to decode our file
     * later into a ByteBuffer. Our metadata consists of the following
     ...
     * number of 'empty bits' in the final byte of this file - The 7-11th bytes
     ...
     * @param symbols a string containg the symbols used by the huffman tree, in
     * an arbitrary order for later decoding.
     * @param fakeBitsTree the number of 'empty bits' in the final byte of
     * @treeRep
